// games/kalambury/src/runtime/phrase-catalog.ts
// Wyodrębniony katalog haseł — importowany przez state-machine i phrase-pool.

export const phraseCatalog: Record<string, { easy: string[]; hard: string[] }> = {
  klasyczne: {
    easy: [
